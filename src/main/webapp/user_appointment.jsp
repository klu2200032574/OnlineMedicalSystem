...
.user-appointment-bg {
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),
		url("img/appointment.webp");
	height: 20vh; /* Restrict height */
	width: 100%;
	background-size: cover;
	background-repeat: no-repeat;
	background-position: center;
	margin-bottom: 20px; /* Add spacing to separate sections */
}
</style>
</head>
<body>
	...
	<!-- Background Section -->
	<div class="container-fulid user-appointment-bg p-5">
	...
	<div class="container p-3">
		<div class="row">
			...
			<div class="col-md-6 p-5">
				<img alt="hospital" src="img/hospital.jpeg" style="width: 100%; height: auto;">
			</div>
